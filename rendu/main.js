function main()
{
    ...
    document.getElementById('cmap1-button').addEventListener('click', function () {
        cmap = 1;
        screen.scene.remove(surfaces);
        isovalue = document.getElementById("isovalue").value;
        surfaces = Isosurfaces( volume, isovalue, cmap);
    ...
    document.getElementById('cmap2-button').addEventListener('click', function () {
        cmap = 2;
        screen.scene.remove(surfaces);
        isovalue = document.getElementById("isovalue").value;
        surfaces = Isosurfaces( volume, isovalue, cmap);
    ...
    document.getElementById('cmap3-button').addEventListener('click', function () {
        cmap = 3;
        screen.scene.remove(surfaces);
        isovalue = document.getElementById("isovalue").value;
        surfaces = Isosurfaces( volume, isovalue, cmap);
